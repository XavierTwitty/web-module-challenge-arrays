...
function is31Flavors(originalFlavors/*code here*/){
...
function addFlavor(flavor, originalFlavors/*code here*/){
...
function removeLastFlavor(originalFlavors/*code here*/){
...
function getFlavorByIndex(originalFlavors, index/*code here*/){
...
function removeFlavorByName( originalFlavors/*code here*/){

    for( originalFlavors= 0; originalFlavors= 31; originalFlavors++){
        if(true){
